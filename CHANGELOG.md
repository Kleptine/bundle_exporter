...
## [2.3.5](https://gitlab.com/AquaticNightmare/bundle_exporter/-/releases/2_3_5)

### Added
- New Panel "Batch Export"
    - It will open the listed blend files one by one and use the "Export All" operator on them.
    - It's recomended to have the output console open to see the progress as blender will appear unresponsive through the operation
### Fixed
- Selected preset will be correctly stored even when the order of the preset enum is changed
...
- Offset Transfrom modifier was not working

## [2.3.4](https://gitlab.com/AquaticNightmare/bundle_exporter/-/releases/2_3_4)
### Fixed
- Export selected bundles was only exporting one bundle
- Rare viewlayer error
...
## [2.3.3](https://gitlab.com/AquaticNightmare/bundle_exporter/-/releases/2_3_3)
### Fixed
- Scene unit settings were being reset after each export
- The addon now works on blender 2.93

## [2.3.2](https://gitlab.com/AquaticNightmare/bundle_exporter/-/releases/2_3_2)
### Added
- Added missing triangulation options
### Changed
- Modifiers no longer have their default settings exposed in the addon settings, it was too "hacky" the way it was implemented and a nightmare to update to 2.93
### Fixed
- Modifiers now appear on blender 2.93 alpha (but they don't work yet)

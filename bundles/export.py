# Top-level export orchestration: validates paths, iterates bundles,
# runs modifiers, resolves output paths, and invokes Blender's export operators.
...
def export_bundles(bundles):
    ...
    for bundle in bundles:
        ...
        with Exporter(bundle, bpy.context.scene.BGE_Settings.path, bpy.context.scene.BGE_Settings.export_format, bpy.context.scene.BGE_Settings.export_preset) as bundle_info:
            ...
            # The validation at the start of export_bundles() ensures this precondition is met.
            #

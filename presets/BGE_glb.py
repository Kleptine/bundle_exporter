...
# op.export_texture_dir = '' # This might fail if the prop is hidden or not available in some modes
...
# op.export_def_bones = False # Might be export_hierarchy_flatten_bones now?
...
# op.export_displacement = False # Removed in recent GLB exporter versions
